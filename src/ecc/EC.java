...
public class EC {
    ...
    public static class Constants {
        ...
        public static ECPoint G = new ECPoint(gx, gy); // generator
    }
    ...
    public static class Points
    {
        ...
        public static String printEPoint (ECPoint point){
    ...
    public static class KeyPair {
        ...
        public KeyPair () {
            ...
            r.nextBytes(r1);
            this.privateKey = new BigInteger(r1).mod(Constants.m);
            this.publicKey = Points.scalmult(Constants.G, this.privateKey);
        }
